...
const Stats = () => {
  return (
    <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6 lg:ml-[190px] `}>      {stats.map((stat) => (
        <div key={stat.id} className={'flex-1 flex justify-start items-center flex-row m-1 mr-[90px]'} >
